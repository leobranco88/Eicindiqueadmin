...
const navItems = [
  ...
  { path: "/relatorios", label: "Relatórios", icon: FileText, activeColor: "#F5A800" },
  { path: "/configuracoes", label: "Configurações", icon: Settings, activeColor: "#070738" },
];
      ...
      <div className="max-w-screen-2xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3">
            <img src={logoSvg.paths} alt="EIC" className="h-8" />
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold shadow-sm" style={{ backgroundColor: '#6B3FA0' }}>
              A
            </div>
          </div>
        </div>
